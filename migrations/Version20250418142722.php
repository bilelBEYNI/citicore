 ...
 */
final class Version20250418142722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE demande CHANGE contenu contenu LONGTEXT NOT NULL, CHANGE Utilisateur_id utilisateur_cin INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE demande ADD CONSTRAINT FK_2694D7A526A98CA9 FOREIGN KEY (utilisateur_cin) REFERENCES utilisateur (Cin)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_2694D7A526A98CA9 ON demande (utilisateur_cin)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement DROP organisateur_id, CHANGE categorie_id categorie_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE demande DROP FOREIGN KEY FK_2694D7A526A98CA9
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_2694D7A526A98CA9 ON demande
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE demande CHANGE contenu contenu TEXT NOT NULL, CHANGE utilisateur_cin Utilisateur_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement ADD organisateur_id INT NOT NULL, CHANGE categorie_id categorie_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement ADD CONSTRAINT categorie_id FOREIGN KEY (categorie_id) REFERENCES categorie (categorie_id)
        SQL);
