 ...
 */
final class Version20250428145709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement DROP organisateur_id, CHANGE id_evenement id_evenement INT AUTO_INCREMENT NOT NULL, CHANGE date_evenement date_evenement VARCHAR(255) DEFAULT NULL, CHANGE lieu_evenement lieu_evenement VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement ADD organisateur_id INT DEFAULT NULL, CHANGE id_evenement id_evenement INT NOT NULL, CHANGE date_evenement date_evenement VARCHAR(255) NOT NULL, CHANGE lieu_evenement lieu_evenement VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
