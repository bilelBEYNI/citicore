 ...
 */
final class Version20250422095533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement DROP organisateur_id, CHANGE id_evenement id_evenement INT AUTO_INCREMENT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement ADD organisateur_id INT DEFAULT NULL, CHANGE id_evenement id_evenement INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
