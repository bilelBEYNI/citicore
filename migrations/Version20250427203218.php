 ...
 */
final class Version20250427203218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE categorie ADD id INT AUTO_INCREMENT NOT NULL, DROP categorie_id, DROP image_url, CHANGE description description VARCHAR(255) DEFAULT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_B26681ED936B2FA ON evenement
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement DROP organisateur_id, CHANGE id_evenement id_evenement INT AUTO_INCREMENT NOT NULL, CHANGE categorie_id categorie_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement ADD CONSTRAINT FK_B26681EBCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie (id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE categorie MODIFY id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX `PRIMARY` ON categorie
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categorie ADD categorie_id INT NOT NULL, ADD image_url VARCHAR(255) NOT NULL, DROP id, CHANGE description description VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categorie ADD PRIMARY KEY (categorie_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement DROP FOREIGN KEY FK_B26681EBCF5E72D
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement ADD organisateur_id INT DEFAULT NULL, CHANGE id_evenement id_evenement INT NOT NULL, CHANGE categorie_id categorie_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
