...
final class AssociationController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('back/ProjetDon/Association/new.html.twig', [
    ...
    {
        return $this->render('back/ProjetDon/Association/show.html.twig', [
            'association' => $association,
        ]);
    }
    ...
    public function edit(Request $request, Association $association, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('back/ProjetDon/Association/edit.html.twig', [
            'association' => $association,
            'form' => $form,
        ]);
    }
