...
class DemandeController extends AbstractController
{
    ...
    #[Route('/demandes/{id}/avis', name: 'app_demande_avis', methods: ['GET'])]
    public function getAvis(int $id): JsonResponse
    {
        // Récupérez les avis associés à la demande
        $avis = $this->getDoctrine()->getRepository(Avis::class)->findBy(['demande' => $id]);

        // Transformez les avis en tableau JSON
        ...
        return new JsonResponse($avisData);
    }
    ...
    public function avisParDemande(int $id, AvisRepository $avisRepository): Response
    {
        $avis = $avisRepository->findBy(['Demande_id' => $id]);
