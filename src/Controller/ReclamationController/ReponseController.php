...
final class ReponseController extends AbstractController
{
    ...
    #[Route('/reponse/reponses/stats', name: 'app_reponse_stats', methods: ['GET'])]
    ...
    #[Route('/reponse/reponses/new/{id}', name: 'app_reponse_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/reponse/{id}/edit', name: 'app_reponse_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/reponse/{id}', name: 'app_reponse_delete', methods: ['POST'])]
